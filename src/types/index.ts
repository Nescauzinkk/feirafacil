...
export interface Product {
  ...
  name: string;
  unit: UnitType;
  price: number; // Preço de Feira Local (antigo 'price')
  priceRegional?: number; // Preço de Feira Regional/Fora
  resalePrice?: number; // Preço de Revenda (Mercado)
  quantity: number;
  recipeId?: string;
...
export type PriceType = 'local' | 'regional' | 'resale';
