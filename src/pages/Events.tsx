      ...
      {viewDay !== null ? (
        ...
        <>
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-2">
              <Button variant={paymentMethod === 'cash' ? 'default' : 'outline'} className="h-14 bg-green-700 hover:bg-green-800 text-white flex-col gap-1 text-xs font-bold" onClick={() => setPaymentMethod('cash')}>
                <Banknote className="h-4 w-4" />Dinheiro
              </Button>
              <Button variant={paymentMethod === 'pix' ? 'default' : 'outline'} className="h-14 bg-green-700 hover:bg-green-800 text-white flex-col gap-1 text-xs font-bold" onClick={() => setPaymentMethod('pix')}>
                <Smartphone className="h-4 w-4" />Pix
              </Button>
              <Button variant={paymentMethod === 'card' ? 'default' : 'outline'} className="h-14 bg-green-700 hover:bg-green-800 text-white flex-col gap-1 text-xs font-bold" onClick={() => setPaymentMethod('card')}>
          ...
          {isMultiDay && !allDaysCompleted ? (
            ...
            <Button variant="destructive" size="lg" className="w-full bg-red-500 hover:bg-red-600 text-white text-lg py-6 mt-4" onClick={() => setShowEndEventConfirm(true)}>
